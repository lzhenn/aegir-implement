...
class ROMSMaker:
    ...
    def __init__(self, cfg_hdl):
        ...
        self.strt_time=datetime.datetime.strptime(cfg_hdl['AEGIR']['model_init_ts'],'%Y%m%d%H')
        model_run_days=int(cfg_hdl['AEGIR']['model_run_days'])
        ...
        self.proj=cfg_hdl['AEGIR']['nml_temp']
