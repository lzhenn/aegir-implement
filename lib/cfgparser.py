...
def merge_cfg(cfg_org, cfg_tgt):
    ...
    cfg_tgt['INPUT']['nml_temp']=cfg_org['AEGIR']['nml_temp']
    cfg_tgt['INPUT']['model_init_ts']=cfg_org['AEGIR']['model_init_ts']
    cfg_tgt['INPUT']['model_run_days']=cfg_org['AEGIR']['model_run_days']
